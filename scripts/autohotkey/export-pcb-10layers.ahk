...
tt = Save As
WinWaitActive, %tt%
SendInput, {Blind} %EXPORT_DIR%\%LZX_PROJECT_NAME%-%LZX_PROJECT_VERSION%-layer-6.gbr!s
WinWaitClose, %tt%

tt = Save As
WinWaitActive, %tt%
SendInput, {Blind} %EXPORT_DIR%\%LZX_PROJECT_NAME%-%LZX_PROJECT_VERSION%-layer-7.gbr!s
WinWaitClose, %tt%

tt = Save As
WinWaitActive, %tt%
SendInput, {Blind} %EXPORT_DIR%\%LZX_PROJECT_NAME%-%LZX_PROJECT_VERSION%-layer-8.gbr!s
WinWaitClose, %tt%

tt = Save As
WinWaitActive, %tt%
SendInput, {Blind} %EXPORT_DIR%\%LZX_PROJECT_NAME%-%LZX_PROJECT_VERSION%-layer-9.gbr!s
WinWaitClose, %tt%

tt = Save As
WinWaitActive, %tt%
SendInput, {Blind} %EXPORT_DIR%\%LZX_PROJECT_NAME%-%LZX_PROJECT_VERSION%-layer-10-bottom.gbr!s
WinWaitClose, %tt%
