...
set(GERBER_FILES ${TMP_PATH} ${GERBER_FILES})
file(TO_NATIVE_PATH ${CMAKE_CURRENT_BINARY_DIR}/${LZX_FILE_PREFIX}layer-10-bottom.gbr TMP_PATH)
set(GERBER_FILES ${TMP_PATH} ${GERBER_FILES})
...
add_custom_command(OUTPUT ${GERBER_FILES}
    COMMAND export-pcb-10layers.exe ${PCB_FILE_PATH} ${SCH_FILE_PATH} ${BINARY_FILE_PATH} ${LZX_PROJECT_NAME} ${LZX_HARDWARE_VERSION} ${SOURCE_FILE_PATH}
